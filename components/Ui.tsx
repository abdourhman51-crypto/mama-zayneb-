...
export function CtaButton({
  ...
  const base =
    'focus-ring tap-feedback inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl px-8 py-4 font-heading text-base transition-all duration-300 sm:text-lg';
  const styles =
    variant === 'primary'
...
export function WhatsAppLink({
  ...
  return (
    <a
      ...
      className={`focus-ring tap-feedback inline-flex items-center gap-2 whitespace-nowrap rounded-2xl px-6 py-3.5 font-heading text-base text-ink transition-colors duration-300 hover:text-pink ${className}`}
    >
