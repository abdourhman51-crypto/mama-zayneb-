  ...
  return (
    <section className="mx-auto max-w-content px-5 py-20 sm:px-8 sm:py-28">
      <div className="mx-auto max-w-2xl">
        ...
        <Reveal as="div"><p className="mt-10 text-center font-heading text-lg leading-[1.9] text-ink sm:text-2xl sm:leading-[1.8]">
          {pain.emphasis}
        </p></Reveal>

        <Reveal><SectionCta note={pain.ctaNote} /></Reveal>
      </div>
    </section>
  );
}
